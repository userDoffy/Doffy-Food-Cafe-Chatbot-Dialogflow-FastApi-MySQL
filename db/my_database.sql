...
--
-- Host: 127.0.0.1    Database: cafe_database
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Momo',6.00),(2,'Chowmin',7.00),(3,'Pizza',8.00),(4,'Lassi',5.00),(5,'Butter Chicken',6.00),(6,'Biryani',9.00),(7,'Garlic Naan',4.00),(8,'Keema Noodles',7.00),(9,'Samosa',5.00);
...
INSERT INTO `order_tracking` VALUES (40,'delivered'),(41,'in transit'),(42,'in progress'),(43,'in progress');
...
INSERT INTO `orders` VALUES (40,1,2,12.00),(40,3,1,8.00),(41,4,3,15.00),(41,6,2,18.00),(41,9,4,20.00),(42,1,2,12.00),(42,4,1,5.00),(43,1,2,12.00);
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'cafe_database'
--
...
DELIMITER ;;
CREATE DEFINER=`doffy`@`localhost` FUNCTION `get_price_for_item`(p_item_name VARCHAR(255)) RETURNS decimal(10,2)
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`doffy`@`localhost` FUNCTION `get_total_order_price`(p_order_id INT) RETURNS decimal(10,2)
    DETERMINISTIC
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`doffy`@`localhost` PROCEDURE `insert_order_item`(
...
-- Dump completed on 2024-05-18  9:39:35
